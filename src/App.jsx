...
- ห้ามลบไฟล์ใดๆ ทั้งสิ้น`}</PromptBox>
        ...
        <section id="resources" style={{ paddingTop: 80 }}>
          ...
          {/* New 7 Grid Cards */}
          <div className="grid-auto-fit" style={{ gap: 20 }}>
            {[
              // 1. Official Docs
              { icon: "📖", title: "Official Anthropic Guides", color: "#8B5CF6", desc: "อ่านคู่มือการใช้งาน Prompt, Skills และ API แบบละเอียดยิบส่งตรงจากผู้สร้าง Claude", url: "https://docs.anthropic.com", type: "Official", tag: "Must Read" },
              // 2. Anthropic Learn
              { icon: "🎓", title: "Anthropic Learn Courses", color: "#60A5FA", desc: "คอร์สเรียนฟรีจาก Anthropic ตั้งแต่ Prompt Engineering ไปจนถึงการใช้ API ในโปรดักชัน", url: "https://learn.anthropic.com", type: "Courses", tag: "เรียนฟรี" },
              // 3. Prompt Library
              { icon: "📚", title: "Claude Prompt Library", color: "#10B981", desc: "คลัง Prompt เกรดพรีเมียมจากทีม Anthropic คัดมาให้แล้วสำหรับทุกสายอาชีพ นำไปใช้ต่อได้เลย", url: "https://docs.anthropic.com/en/prompt-library/library", type: "Official", tag: "พร้อมใช้" },
              // 4. Anthropic Cookbook (New)
              { icon: "🍳", title: "Anthropic Cookbook", color: "#38BDF8", desc: "Official recipes และโค้ดตัวอย่างขั้นสูงบน GitHub สำหรับการดึงพลังสูงสุดของ Claude ไปสร้างแอปจริง", url: "https://github.com/anthropic/anthropic-cookbook", type: "GitHub", tag: "🌟 7k+" },
              // 5. MCP (New)
              { icon: "🔌", title: "Model Context Protocol", color: "#F59E0B", desc: "มาตรฐานใหม่ (MCP) สำหรับสร้าง Connectors ให้ Claude เข้าถึงข้อมูลในเครื่องและ Cloud (Repo หลัก)", url: "https://github.com/modelcontextprotocol", type: "Core Tech", tag: "🌟 4k+" },
              // 6. Awesome MCP Servers (New)
              { icon: "🌐", title: "awesome-mcp-servers", color: "#EC4899", desc: "รวม MCP Servers (Connectors) พร้อมใช้กว่า 100+ ตัวสำหรับเชื่อมต่อ Database, Tools, และ APIs ภายนอก", url: "https://github.com/punkpeye/awesome-mcp-servers", type: "Community", tag: "🌟 3.5k+" },
              // 7. Awesome Claude Code (Existing)
              { icon: "💻", title: "awesome-claude-code", color: "#F43F5E", desc: "รวม Prompts เด็ด และ Skills พร้อมใช้สำหรับ Claude Desktop/Code อัปเดตสม่ำเสมอจากคอมมูนิตี้", url: "https://github.com/hesreallyhim/awesome-claude-code", type: "Community", tag: "🌟 13k+" },
            ].map((res, i) => (
              <a key={i} href={res.url} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none" }}>
                <Card color={res.color} className="hover-lift" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                    <div style={{ fontSize: 32 }}>{res.icon}</div>
                    <div style={{ display: "flex", gap: 6, flexDirection: "column", alignItems: "flex-end" }}>
                      <span style={{ background: `${res.color}15`, color: res.color, padding: "2px 8px", borderRadius: 8, fontSize: 10, fontWeight: 800 }}>{res.type}</span>
                      <span style={{ background: "rgba(15,23,42,0.05)", color: "#475569", padding: "2px 8px", borderRadius: 8, fontSize: 10, fontWeight: 700 }}>{res.tag}</span>
                    </div>
                  </div>
                  <h3 style={{ fontSize: 16, fontWeight: 800, color: res.color, marginBottom: 8, lineHeight: 1.4 }}>{res.title}</h3>
                  <p style={{ color: "var(--text-muted)", fontSize: 13, lineHeight: 1.7, marginBottom: 16, flex: 1 }}>{res.desc}</p>
                  <div style={{ fontSize: 12, color: res.color, fontWeight: 700 }}>ดูข้อมูลเพิ่มเติม →</div>
                </Card>
              </a>
            ))}
          </div>
